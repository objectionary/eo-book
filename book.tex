...
plus. > @
  ...
  32.0
\end{ffcode}
contain the body of the abstract object \ff{celsToFahr}. Here \ff{cels} free attribute is used to calculate the final number of degrees Fahrenheit. Object \ff{celsToFahr} decorates result of this calculations, so it will be dataized as this result.
