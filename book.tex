...
The object \ff{org.eolang.math.number} is a decorator of \ff{org.eolang.int}. So the number object contains methods for working with \ff{int} data objects. Before using these methods, you need to make such an application:
\begin{ffcode}
