...
Here is an example of program that removes numbers that  are less than or equals to \ff{3} from an array of integers:
...
[args...] > app
  list > arr
    * 7 2 1 0 9 4 8 3 6 5
  filter-arr arr > new-arr
  memory 0 > x
  seq > @
    while.
      x.lt (new-arr.length.minus 1)
      [i]
        seq > @
          stdout
            sprintf "%d "
...
list > arr
  * 7 2 1 0 9 4 8 3 6 5
\end{ffcode}
declares closed object \ff{arr}. Here the object \ff{* 7 2 1 0 9 4 8 3 6 5} is an array declared with the symbol \ff{*}. The object \ff{list} decorates the array that is applied to it. This object provides some additional attributes for working with arrays, they will be used later.
...
+alias dir org.eolang.fs.dir
\end{ffcode}
new aliases are declared (\ff{org.eolang.txt.regex} and \ff{org.eolang.fs.dir}). 

Let's consider how does \ff{find-eo-fiies} abstract object works.
...
\hl{add section about} \ff{if} \hl{attribute}
